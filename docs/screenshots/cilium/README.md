...
Cilium `1.19.4` installed as the sole CNI on `eks-platform-dev-ap-northeast-1` (Kubernetes `1.36`, `ap-northeast-1`, account `730269305302`) in ENI IPAM mode with eBPF kube-proxy replacement and Hubble observability. Captured 2026-06-24.
