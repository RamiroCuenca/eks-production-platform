...
| **OWASP ZAP (DAST)** | A post-deploy concern — it belongs with the application's live deployment and lands alongside it (see [Roadmap](#roadmap)). |
